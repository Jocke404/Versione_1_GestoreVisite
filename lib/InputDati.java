...
public class InputDati 
{
	...
	public static LocalDate leggiData(String messaggio) {
		...
		do {
			...
			try {
				...
				dataLetta = LocalDate.parse(input, DATE_FORMATTER);
				finito = true;
	...
	public static List<LocalDate> leggiDataMultipla(String messaggio) {
		List<LocalDate> dateLette = new ArrayList<>();
		boolean continua;
		do {
			dateLette.add(leggiData(messaggio));
